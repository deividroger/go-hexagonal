...
import (
	...
	application "github.com/deividroger/go-hexagonal/application"
...
func (m *MockProductServiceInterface) Get(id string) (application.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.Product)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// MockProductPersistenceInteface is a mock of ProductPersistenceInteface interface.
type MockProductPersistenceInteface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersistenceIntefaceMockRecorder
}

// MockProductPersistenceIntefaceMockRecorder is the mock recorder for MockProductPersistenceInteface.
type MockProductPersistenceIntefaceMockRecorder struct {
	mock *MockProductPersistenceInteface
}

// NewMockProductPersistenceInteface creates a new mock instance.
func NewMockProductPersistenceInteface(ctrl *gomock.Controller) *MockProductPersistenceInteface {
	mock := &MockProductPersistenceInteface{ctrl: ctrl}
	mock.recorder = &MockProductPersistenceIntefaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPersistenceInteface) EXPECT() *MockProductPersistenceIntefaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPersistenceInteface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPersistenceIntefaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersistenceInteface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPersistenceInteface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistenceIntefaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistenceInteface)(nil).Save), product)
}
